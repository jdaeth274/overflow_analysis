...
system.time(costs_dataset <- vroom("D:/Overflows/data/cleaned_2015_2019_orgrcs.csv", delim = ","))
...
national_rcs1819 <- read.csv("D:/Overflows/data/national_rcs1819.csv", fileEncoding = "UTF-8-BOM")

# load national ref cost data for 1718 - for costs that are unmatched after using national_rcs1213
national_rcs1718 <- read.csv("D:/Overflows/data/national_rcs1718.csv",fileEncoding = "UTF-8-BOM")

# load national ref cost data for 1617 - for costs that are unmatched after using national_rcs1112
national_rcs1617 <- read.csv("D:/Overflows/data/national_rcs1617.csv",fileEncoding = "UTF-8-BOM")

# load national ref cost data for 1516 - for costs that are unmatched after using national_rcs1011
national_rcs1516 <- read.csv("D:/Overflows/data/national_rcs1516.csv",fileEncoding = "UTF-8-BOM")

##############################################################################################################
# Pre-process HES data
# Keep HES data of yoi (FY of interest)
FY = 1213 ################################################# JD: I think here is where we can specify on the overflows masters sheet for each year?
